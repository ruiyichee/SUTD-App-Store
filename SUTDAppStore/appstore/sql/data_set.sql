...
alter table application modify icon VARCHAR(5000);

update application set icon="assets/img/candycrush.png" where aid=1;
update application set icon="assets/img/templerun.png" where aid=2;
update application set icon="assets/img/templerun2.png" where aid=3;
update application set icon="assets/img/race.png" where aid=4;
update application set icon="assets/img/subway_surfer.png" where aid=5;
update application set icon="assets/img/tetris.png" where aid=6;
update application set icon="assets/img/brick_breaker.png" where aid=7;
update application set icon="assets/img/aircraft.jpg" where aid=8;
update application set icon="assets/img/flappy_bird.png" where aid=9;
update application set icon="assets/img/bowling.png" where aid=10;
update application set icon="assets/img/cricket.jpg" where aid=11;
update application set icon="assets/img/carrom.png" where aid=12;
update application set icon="assets/img/basket_ball.png" where aid=13;
update application set icon="assets/img/flip_cup.jpg" where aid=14;
update application set icon="assets/img/gameon.png" where aid=15;
update application set icon="assets/img/farmville.png" where aid=16;
update application set icon="assets/img/pokemon.png" where aid=17;
update application set icon="assets/img/supermario.png" where aid=18;
update application set icon="assets/img/mario.png" where aid=19;
update application set icon="assets/img/pacman.png" where aid=20;
update application set icon="assets/img/pacman2.png" where aid=21;